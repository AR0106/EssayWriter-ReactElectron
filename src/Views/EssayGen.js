    ...
    render() {
        return (
            <div className="GenView">
                ...
                <button onClick={async () => {ipcRenderer.send('genHistory-save', 'test1.txt', 'Hello, World!')}}>Write</button>
                <button onClick={async() => {document.getElementById('outBox').innerHtml = ipcRenderer.send('genHistory-load', 'test1.txt')}}>Read</button>
